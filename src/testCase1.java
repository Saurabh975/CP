...
public class testCase1 {
    ...
    static void Mangni_ke_bail_ke_dant_na_dekhal_jye() {
        ...
        long n = 10000;//(long) (random() * 1e4);
        long m = 1000;//(long) (random() * 1e3) + 1;
        int z = 100;//(int) (random() * 99) + 2;
        k = 99;//(int) (random() * z);
        p(n);
        p(m);
        p(k);
        pl(z);
        for (int i = 0; i < m; i++)p((int) (Math.random() * 10));
        pl();
    }
...
//            pw = new PrintWriter(System.out, true);
            input = new AwesomeInput(new FileInputStream("/home/saurabh/Desktop/testcases/i0.txt"));
            pw = new PrintWriter(new BufferedWriter(new FileWriter("/home/saurabh/Desktop//testcases/i5.txt")), true);
