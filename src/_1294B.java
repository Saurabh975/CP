...
public class _1294B {
    ...
    static void Mangni_ke_bail_ke_dant_na_dekhal_jye() {
        t = ni();
        Comparator<data> c = (data a, data b) -> a.a == b.a ? a.b - b.b : a.a - b.a;
        here:
        while (t-- > 0) {
            n = ni();
            PriorityQueue<data> pq = new PriorityQueue<>(c);
            for (int i = 0; i < n; i++) pq.add(new data(ni(), ni()));
            //pl(pq);
            int x = 0, y = 0;
            ...
            while (!pq.isEmpty()) {
                ...
                if (t.a - x < 0 || t.b - y < 0) {
                    ...
                    for (int i = x; i < t.a; i++) sb.append("R");
                    for (int i = y; i < t.b; i++) sb.append("U");
                }
                x = t.a;
                y = t.b;
            }
